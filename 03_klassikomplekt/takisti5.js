var Resistor = /** @class */ (function () {
    ...
    Resistor.prototype.draw = function () {
        ...
        this.g.fillText(this.n.toFixed(3) + " W", this.startx + this.width / 4, this.y + this.height / 2);
    };
    ...
    Resistor.prototype.setN = function () {
        this.calculateCurrent();
        this.n = this.i * this.u;
    };
    Resistor.prototype.getN = function () {
        return this.n;
    };
    return Resistor;
}());
